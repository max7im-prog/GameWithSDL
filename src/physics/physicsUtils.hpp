...
public:
   ...
   static std::pair<entt::entity, b2BodyId> createPolygonPhysicsBody(entt::registry &registry,
   ...
   static std::pair<entt::entity, b2BodyId> createCirclePhysicsBody(entt::registry &registry,
                                                                    const entt::entity &entity,
                                                                    b2WorldId worldId,
                                                                    b2Vec2 position,
                                                                    b2Vec2 center,
   ...
   static std::pair<entt::entity, b2BodyId> createCapsulePhysicsBody(entt::registry &registry,
                                                                     const entt::entity &entity,
                                                                     b2WorldId worldId,
                                                                     b2Vec2 position,
                                                                     b2Vec2 center1,
   ...
   static std::pair<entt::entity, b2BodyId> createSegmentPhysicsBody(entt::registry &registry,
                                                                     const entt::entity &entity,
                                                                     b2WorldId worldId,
                                                                     b2Vec2 position,
                                                                     b2Vec2 point1,
   ...
   static std::pair<entt::entity, b2JointId> createDistancePhysicsJoint(entt::registry &registry,
                                                                        const entt::entity &entity,
                                                                        b2WorldId worldId,
                                                                        b2BodyId bodyAId,
                                                                        b2BodyId bodyBId,
   ...
   static std::pair<entt::entity, b2JointId> createPrismaticPhysicsJoint(entt::registry &registry,
                                                                         const entt::entity &entity,
                                                                         b2WorldId worldId,
                                                                         b2BodyId bodyAId,
                                                                         b2BodyId bodyBId,
   ...
   static std::pair<entt::entity, b2BodyId> createEmptyPhysicsBody(entt::registry &registry,
                                                                   const entt::entity &entity,
                                                                   b2WorldId worldId,
                                                                   b2Vec2 position,
                                                                   b2BodyType bodyType = b2_staticBody);

   static std::pair<entt::entity, b2JointId> createRevolutePhysicsJoint(entt::registry &registry,
                                                                        const entt::entity &entity,
                                                                        b2WorldId worldId,
                                                                        b2BodyId bodyAId,
                                                                        b2BodyId bodyBId,
                                                                        b2Vec2 worldPoint);
   static std::pair<entt::entity, b2JointId> createMousePhysicsJoint(entt::registry &registry,
                                                                     const entt::entity &entity,
                                                                     b2WorldId worldId,
